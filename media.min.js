...
c;for(var c=0,h=e.listeners.length;c<h;c++)e.listeners[c]&&e.listeners[c].call(d,e.mql,b)}}while(a--)},10)},setMutableFeatures:function(){Media.features.width=d.innerWidth||n.clientWidth;Media.features.height=d.innerHeight||n.clientHeight;Media.features["aspect-ratio"]=(Media.features.width/Media.features.height).toFixed(2)},listen:function(b){d.addEventListener?(d.addEventListener("resize",b),d.addEventListener("orientationchange",b)):d.attachEvent&&(d.attachEvent("onresize",b),d.attachEvent("onorientationchange",
