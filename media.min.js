...
(d.addEventListener("resize",a),d.addEventListener("orientationchange",a)):d.attachEvent&&(d.attachEvent("onresize",a),d.attachEvent("onorientationchange",a))},init:function(){var a=d.devicePixelRatio||1;this.supported=1===parseFloat(f.height);this.type="screen print speech projection handheld tv braille embossed tty".split(" ")[parseFloat(f.zIndex)-1]||"all";this.features.resolution=a&&96*a||screen.deviceXDPI||parseFloat(f.width);this.features["device-pixel-ratio"]=a;this.setMutableFeatures();this.listen(this.watch)}};
d.Media.init();window.matchMedia||(window.matchMedia=Media.match)})(window);